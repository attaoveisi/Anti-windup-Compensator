...
LMI=list(-([R11*Ap'+Ap*R11,Bpw,R11*Cpz';Bpw',-gama*eye(nw,nw),Dpzw';Cpz*R11,Dpzw,-gama*eye(nz,nz)]),-([S*Acl'+Acl*S,Bclw,S*Cclz';Bclw',-gama*eye(nw,nw),Dclzw';Cclz*S,Dclzw,-gama*eye(nz,nz)]),([R11,R12;R12',R22]),([R11,R12;R12',R22])-S,S,3-gama)
OBJ=[]
endfunction
...
reltol=1e-1;
options=[Mbound,abstol,nuu,maxiters,reltol];
Ans_LMI2=lmisolver(Init_guess,AW_feas1,options);
