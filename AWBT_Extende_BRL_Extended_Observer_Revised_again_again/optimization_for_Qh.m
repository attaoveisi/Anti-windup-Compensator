function [x,fval,exitflag,output,population,score] = optimization_for_Qh(nvars,lb,ub,PopulationSize_Data,EliteCount_Data,CrossoverFraction_Data,MigrationFraction_Data,Generations_Data,StallGenLimit_Data,TolFun_Data,TolCon_Data)
...
ga(@finding_Qh,nvars,[],[],[],[],lb,ub,[],[],options);
